...
**Current implementation or contract:** `src/assuranceos/db/models/evidence.py`

Typed evidence lineage and canonical relationship persistence for current workflows.
