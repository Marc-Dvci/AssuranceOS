# Known limitations — Continuous Monitoring Agent
...
- This role cannot exceed its declared authority. In particular, it must not: convert an alert directly into an approved finding, conclude when source freshness or completeness is below threshold, alter thresholds or escalation policy without release approval.
