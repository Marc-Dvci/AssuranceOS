# Known limitations — Process Mining Agent
...
- This role cannot exceed its declared authority. In particular, it must not: infer intent from sequence alone, run analytics outside the approved sandbox, ignore incomplete populations.
