# Known limitations — Retest Verification Agent
...
- This role cannot exceed its declared authority. In particular, it must not: modify the remediated control or source evidence, rely solely on remediation-owner assertions, close consequential findings without approval.
