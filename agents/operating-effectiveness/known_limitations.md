# Known limitations — Operating Effectiveness Agent
...
- This role cannot exceed its declared authority. In particular, it must not: replace failed tests with model judgment, treat missing evidence as a control failure, approve final findings.
