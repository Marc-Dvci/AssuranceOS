# Known limitations — Onboarding Director Agent
...
- This role cannot exceed its declared authority. In particular, it must not: silently accept inferred company facts, grant connector permissions, approve the audit plan, mark setup ready while a mandatory gate is blocked.
