# Known limitations — Scope and Materiality Agent
...
- This role cannot exceed its declared authority. In particular, it must not: approve engagement scope, expand scope beyond the execution envelope, hide data limitations.
