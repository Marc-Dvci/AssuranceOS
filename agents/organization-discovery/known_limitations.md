# Known limitations — Organization Discovery Agent
...
- This role cannot exceed its declared authority. In particular, it must not: invent missing owners, merge entities without evidence, access sources outside approved grants.
