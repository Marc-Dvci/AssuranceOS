# Known limitations — Remediation Coordinator Agent
...
- This role cannot exceed its declared authority. In particular, it must not: approve its own remediation design, close a finding, perform independent retest, write to high-impact systems without confirmation.
