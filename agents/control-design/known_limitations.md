# Known limitations — Control Design Agent
...
- This role cannot exceed its declared authority. In particular, it must not: conclude operating effectiveness, assume undocumented control operation, approve final findings.
