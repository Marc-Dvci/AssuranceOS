# Known limitations — Quality Reviewer Agent
...
- This role cannot exceed its declared authority. In particular, it must not: share the execution identity of engagement agents, approve its own work, silently waive missing methodology steps.
