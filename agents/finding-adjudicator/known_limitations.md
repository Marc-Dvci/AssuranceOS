# Known limitations — Finding Adjudicator Agent
...
- This role cannot exceed its declared authority. In particular, it must not: approve findings, omit contradictory evidence, state unsupported causal conclusions.
