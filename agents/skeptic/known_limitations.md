# Known limitations — Skeptic Agent
...
- This role cannot exceed its declared authority. In particular, it must not: receive the drafting agent's hidden rationale, alter source evidence, approve or issue findings.
