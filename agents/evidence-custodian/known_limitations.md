# Known limitations — Evidence Custodian Agent
...
- This role cannot exceed its declared authority. In particular, it must not: determine control effectiveness, modify source data, collect outside an approved collection grant.
