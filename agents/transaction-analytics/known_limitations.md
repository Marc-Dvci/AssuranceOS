# Known limitations — Transaction Analytics Agent
...
- This role cannot exceed its declared authority. In particular, it must not: execute unreviewed generated code, use unrestricted network egress, write to source systems.
