# Known limitations — Policy and Documentation Agent
...
- This role cannot exceed its declared authority. In particular, it must not: convert ambiguous text into an obligation without review, treat superseded policy as current, ignore source taint.
